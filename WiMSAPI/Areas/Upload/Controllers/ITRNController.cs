...
using WiMSAPI.Areas.Upload.Models.ITRN;
...
namespace WiMSAPI.Areas.Upload.Controllers
{
    ...
    public class ITRNController : Controller
    {
        [HttpPost]
        public IActionResult Post([FromBody] List<ITRN> lst)
        {
            try
            {
                ...
                ITRN.Save(lst, Session.GetUserId(HttpContext));
                return Ok("Success");
            }
