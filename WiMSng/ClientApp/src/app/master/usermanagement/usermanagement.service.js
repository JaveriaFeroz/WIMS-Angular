...
let UserManagementService = class UserManagementService {
    ...
    getUsers() {
        return this.http.get(this.apiURL + 'master/UserManagement/');
    }
    get(userid) {
        return this.http.get(this.apiURL + 'master/UserManagement/' + userid);
    }
    save(userprofile) {
        return this.http.post(this.apiURL + 'master/UserManagement/', userprofile);
    }
};
