...
exports.WF_RateSheetComponent = void 0;
...
let WF_RateSheetComponent = class WF_RateSheetComponent {
    //#endregion
    constructor(router, formbulider, svcToaster, svcWFRateSheet, svcWaitDlg, svcSearchDlg, route, svcHistoryDlg, svcRecipient, svcFormSubmission, svcAuth) {
        this.router = router;
        this.formbulider = formbulider;
        this.svcToaster = svcToaster;
        this.svcWFRateSheet = svcWFRateSheet;
        ...
        this.minDate = agFormHelper_1.agFormHelper.addDays(0);
        this.maxDate = agFormHelper_1.agFormHelper.addDays(730);
        ...
        this.colStorage = [
            {
                ...
                children: [
                    ...
                    {
                        headerName: "Type", field: "stId", cellEditor: agGridHelper_1.agGridHelper.getAgilitySelect(),
                        cellEditorParams: { source: 'SType', class: "150" }, valueFormatter: agGridHelper_1.agGridHelper.getSTypeName, width: 150
                    },
                    {
                        headerName: "Unit", field: "suId", cellEditor: agGridHelper_1.agGridHelper.getAgilitySelect(),
                        cellEditorParams: { source: 'SUnit', class: "110" }, valueFormatter: agGridHelper_1.agGridHelper.getSUnitName, width: 110
                    },
                    {
                        headerName: "Period", field: "periodTypeId", cellEditor: agGridHelper_1.agGridHelper.getAgilitySelect(),
                        cellEditorParams: { source: 'PeriodType', class: "60" }, valueFormatter: agGridHelper_1.agGridHelper.getPeriodTypeName, width: 60
                    },
                    {
        ...
        this.colStorageLoc = [
            {
                ...
                children: [
                    {
                        headerName: "Location Category", field: "lcId", cellEditor: agGridHelper_1.agGridHelper.getAgilitySelect(),
                        cellEditorParams: { source: 'LocCat', class: "175" }, valueFormatter: agGridHelper_1.agGridHelper.getLocCatName, width: 175
                    },
                    {
        ...
        this.colExemptLoc = [
            {
                ...
                children: [
                    {
                        headerName: "Location Category", field: "lcId", cellEditor: agGridHelper_1.agGridHelper.getAgilitySelect(),
                        cellEditorParams: { source: 'LocCat', class: "225" }, valueFormatter: agGridHelper_1.agGridHelper.getLocCatName, width: 225
                    },
                    {
                        headerName: "A", field: "action", width: 30, editable: false
                    },
        ...
        this.colHandling = [
            {
                ...
                children: [
                    ...
                    {
                        headerName: "Type", field: "htId", cellEditor: agGridHelper_1.agGridHelper.getAgilitySelect(), headerTooltip: "Handling Type",
                        cellEditorParams: { source: 'HType', class: "100" }, valueFormatter: agGridHelper_1.agGridHelper.getHTypeName, width: 100
                    },
                    {
                        headerName: "Unit", field: "huId", cellEditor: agGridHelper_1.agGridHelper.getAgilitySelect(), headerTooltip: "Handling Unit",
                        cellEditorParams: { source: 'HUnit', class: "110" }, valueFormatter: agGridHelper_1.agGridHelper.getHUnitName, width: 110
                    },
                    {
                        headerName: "Rate", field: "rate", type: "numericColumn", width: 80,
                        valueFormatter: agGridHelper_1.agGridHelper.formatNumbers, valueParser: agGridHelper_1.agGridHelper.numberValueParser
                    ...
                    {
                        headerName: "L.Unit", field: "looseUnitId", cellEditor: agGridHelper_1.agGridHelper.getAgilitySelect(), headerTooltip: "UoM For Loose Unit Handling",
                        cellEditorParams: { source: 'LUnit', class: "80" }, valueFormatter: agGridHelper_1.agGridHelper.getLUnit, width: 80
                    },
                    {
        ...
        this.colHandlingContainer = [
            {
                ...
                children: [
                    {
                        headerName: "Container Capacity", field: "containerTypeId", cellEditor: agGridHelper_1.agGridHelper.getAgilitySelect(),
                        cellEditorParams: { source: 'ContainerType', class: "180" }, valueFormatter: agGridHelper_1.agGridHelper.getContainerTypeName, width: 180
                    },
                    {
        ...
        this.colFixed = [
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        cellEditorParams: { source: 'Charge', class: "220" }, valueFormatter: agGridHelper_1.agGridHelper.getChargeName, width: 220
                    },
                    {
        ...
        this.colRemarks = [
            {
                ...
                children: [
                    {
                        headerName: "Invoice Type", field: "workFlowId", cellEditor: agGridHelper_1.agGridHelper.getAgilitySelect(),
                        cellEditorParams: { source: 'WorkFlow', class: "150" }, valueFormatter: agGridHelper_1.agGridHelper.getWorkFlowName, width: 150
                    },
    ...
    ngOnInit() {
        this.frmWFRateSheet = this.formbulider.group({
            ...
            calendarId: [null, [forms_1.Validators.required]],
            minInvAmount: [null],
            expiryDate: [null, [forms_1.Validators.required]],
            isActive: [null],
            stateId: [null],
            stateName: [null],
            owner: [null],
    ...
    tbSave() {
        try {
            ...
            if (!this.frmWFRateSheet.invalid) {
                var formData = this.frmWFRateSheet.getRawValue();
                ...
                if (this.errors.length > 0) {
                    ...
                    this.svcWaitDlg.open({});
                    this.svcWFRateSheet.save(formData).subscribe(result => {
    ...
    tbHistory(formId) {
        try {
            this.svcWaitDlg.open({});
            this.svcRecipient.getHistory(agEnum_1.agEnum.WorkFlow.WFRateSetup, formId).subscribe(r => {
                this.svcHistoryDlg.open("Client Rate Setup Request - " + formId, agGridHelper_1.agGridHelper.colHistory, r);
            }, error => { this.svcToaster.showFailure(error); }, () => { this.svcWaitDlg.close(); });
        }
        catch (e) {
        ...
        return new Promise((resolve, reject) => {
            try {
                if (stateId == 2 || stateId == 5) {
                    ...
                    recipients = this.svcRecipient.getCreator(agEnum_1.agEnum.WorkFlow.WFRateSetup, formId);
                }
                rxjs_1.forkJoin([recipients]).subscribe(results => {
                    ...
                    if (recipients === undefined || recipients.length == 0) {
                        ...
                        this.svcFormSubmission.open(agEnum_1.agEnum.getRateState(nextStateId) + " - RateSheet # " + this.frmWFRateSheet.controls.formId.value, agEnum_1.agEnum.getRateState(nextStateId), recipients);
        ...
        try {
            if (this.goStorage.api.getSelectedRows().length > 0) {
                if (confirm("Are you sure you want to Delete selected row(s)?")) {
                    ...
                    agGridHelper_1.agGridHelper.setGridDeleteFilter(this.goStorage.api);
        ...
        try {
            if (this.goStorageLoc.api.getSelectedRows().length > 0) {
                if (confirm("Are you sure you want to Delete selected row(s)?")) {
                    ...
                    agGridHelper_1.agGridHelper.setGridDeleteFilter(this.goStorageLoc.api);
                }
            }
            else
                this.svcToaster.showFailure('No Row selected to apply Delete operation. Please select row and then hit Delete button!', 'Delete Request Failed');
        ...
        try {
            if (this.goExemptLoc.api.getSelectedRows().length > 0) {
                if (confirm("Are you sure you want to Delete selected row?")) {
                    ...
                    agGridHelper_1.agGridHelper.setGridDeleteFilter(this.goExemptLoc.api);
                }
            }
            else
                this.svcToaster.showFailure('No Row selected to apply Delete operation. Please select row and then hit Delete button!', 'Delete Request Failed');
        ...
        try {
            if (this.goHandlingContainer.api.getSelectedRows().length > 0) {
                if (confirm("Are you sure you want to Delete selected row?")) {
                    ...
                    agGridHelper_1.agGridHelper.setGridDeleteFilter(this.goHandlingContainer.api);
                }
            }
            else
                this.svcToaster.showFailure('No Row selected to apply Delete operation. Please select row and then hit Delete button!', 'Delete Request Failed');
        ...
        try {
            if (this.goHandlingSKU.api.getSelectedRows().length > 0) {
                if (confirm("Are you sure you want to Delete selected row?")) {
                    ...
                    agGridHelper_1.agGridHelper.setGridDeleteFilter(this.goHandlingSKU.api);
                }
            }
            else
                this.svcToaster.showFailure('No Row selected to apply Delete operation. Please select row and then hit Delete button!', 'Delete Request Failed');
        ...
        try {
            if (this.goFixed.api.getSelectedRows().length > 0) {
                if (confirm("Are you sure you want to Delete selected row?")) {
                    ...
                    agGridHelper_1.agGridHelper.setGridDeleteFilter(this.goFixed.api);
                }
            }
            else
                this.svcToaster.showFailure('No Row selected to apply Delete operation. Please select row and then hit Delete button!', 'Delete Request Failed');
        ...
        try {
            if (this.goVariable.api.getSelectedRows().length > 0) {
                if (confirm("Are you sure you want to Delete selected row?")) {
                    ...
                    agGridHelper_1.agGridHelper.setGridDeleteFilter(this.goVariable.api);
                }
            }
            else
                this.svcToaster.showFailure('No Row selected to apply Delete operation. Please select row and then hit Delete button!', 'Delete Request Failed');
        ...
        try {
            if (this.goRemarks.api.getSelectedRows().length > 0) {
                if (confirm("Are you sure you want to Delete selected row?")) {
                    ...
                    agGridHelper_1.agGridHelper.setGridDeleteFilter(this.goRemarks.api);
                }
            }
            else
                this.svcToaster.showFailure('No Row selected to apply Delete operation. Please select row and then hit Delete button!', 'Delete Request Failed');
    ...
    loadExisting() {
        const rs = this.frmWFRateSheet.getRawValue();
        if (rs.storerGroupId && rs.pcId) {
            this.svcWaitDlg.open({});
            try {
                this.svcWFRateSheet.getExisting(rs.storerGroupId, rs.pcId).subscribe(data => {
                    if (data) {
                        //this.frmWFRateSheet.disable();
                        ...
                        this.frmWFRateSheet.controls['stateName'].setValue(agEnum_1.agEnum.getRateState(0));
                        ...
                        this.frmWFRateSheet.controls.storerGroupId.disable();
                        this.frmWFRateSheet.controls.pcId.disable();
                        this.setActionBarVisibility(agFormHelper_1.agFormMode.Add);
                        agFormHelper_1.agFormHelper.setGridToolbar(true);
                        agFormHelper_1.agFormHelper.setGridStatus(true);
                    }
                    else {
    ...
    get(id) {
        this.svcWaitDlg.open({});
        try {
            this.svcWFRateSheet.get(id).subscribe(data => {
                if (data) {
                    this.frmWFRateSheet.disable();
                    ...
                    this.frmWFRateSheet.controls['stateName'].setValue(agEnum_1.agEnum.getRateState(data.stateId));
    ...
    loadLookup() {
        try {
            this.svcWFRateSheet.getLookup().subscribe(data => {
    ...
    onRHCCellValueChanged(params) {
        ...
        if (params.colDef.field == "containerTypeId") {
            if (params.data.containerTypeId != "") {
                ...
                params.node.setDataValue("containerTypeId", null);
            }
        }
    }
...
], WF_RateSheetComponent.prototype, "storerGroupId", void 0);
__decorate([
    core_1.ViewChild('formId', { static: true })
], WF_RateSheetComponent.prototype, "formId", void 0);
__decorate([
    core_1.ViewChild('btnEdit', { static: true })
], WF_RateSheetComponent.prototype, "btnEdit", void 0);
WF_RateSheetComponent = __decorate([
    core_1.Component({
        selector: 'app-wfratesheet',
        templateUrl: './wf_ratesheet.component.html',
        styleUrls: ['./wf_ratesheet.component.css']
    })
], WF_RateSheetComponent);
exports.WF_RateSheetComponent = WF_RateSheetComponent;
//# sourceMappingURL=wf_ratesheet.component.js.map