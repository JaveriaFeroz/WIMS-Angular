...
exports.LocationCategoryComponent = void 0;
const core_1 = require("@angular/core");
const xlsx = require("xlsx");
const agFormHelper_1 = require("../../helper/agFormHelper");
const footer_1 = require("../../helper/footer");
const LocationCategory_1 = require("./LocationCategory");
let LocationCategoryComponent = class LocationCategoryComponent {
    //#endregion
    ...
    tbSave() {
        try {
            ...
            if (!this.frmLocationCategory.invalid) {
                var formData = this.frmLocationCategory.getRawValue();
                ...
                fileReader.onload = (e) => {
                    ...
                    if (this.errors.length > 0) {
                        ...
                        var LocationCategorys = this.getData(jsonData, jsonData[0].length);
                        if (this.errors.length == 0)
    ...
    getData(jsonData, headerLength) {
        this.errors = [];
        var lcs = [], proNumber = "", LC = new LocationCategory_1.LocationCategory();
        for (let i = 1; i < jsonData.length; i++) {
            ...
            if (currentRecord.length == headerLength) {
                ...
                //  sts.push(st);
                //}
                LC = new LocationCategory_1.LocationCategory();
...
], LocationCategoryComponent.prototype, "whId", void 0);
...
//# sourceMappingURL=LocationCategory.component.js.map