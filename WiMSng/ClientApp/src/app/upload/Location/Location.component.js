...
let LocationComponent = class LocationComponent {
    ...
    tbSave() {
        try {
            ...
            if (!this.frmLocation.invalid) {
                var formData = this.frmLocation.getRawValue();
                ...
                fileReader.onload = (e) => {
                    ...
                    if (this.errors.length > 0) {
                        ...
                        var Locations = this.getData(jsonData, jsonData[0].length);
                        if (this.errors.length == 0)
    ...
    getData(jsonData, headerLength) {
        this.errors = [];
        var lcs = [], proNumber = "", LC = new Location_1.Location();
...
], LocationComponent.prototype, "whId", void 0);
