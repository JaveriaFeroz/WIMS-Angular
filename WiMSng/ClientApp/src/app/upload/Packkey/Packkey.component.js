...
exports.PackkeyComponent = void 0;
const core_1 = require("@angular/core");
const xlsx = require("xlsx");
const agFormHelper_1 = require("../../helper/agFormHelper");
const footer_1 = require("../../helper/footer");
const Packkey_1 = require("./Packkey");
let PackkeyComponent = class PackkeyComponent {
    //#endregion
    ...
    tbSave() {
        try {
            ...
            if (!this.frmPackkey.invalid) {
                var formData = this.frmPackkey.getRawValue();
                ...
                fileReader.onload = (e) => {
                    ...
                    if (this.errors.length > 0) {
                        ...
                        var Packkeys = this.getData(jsonData, jsonData[0].length);
                        if (this.errors.length == 0)
    ...
    getData(jsonData, headerLength) {
        this.errors = [];
        var lcs = [], proNumber = "", LC = new Packkey_1.Packkey();
...
], PackkeyComponent.prototype, "whId", void 0);
PackkeyComponent = __decorate([
    core_1.Component({
        selector: 'app-st',
...
exports.PackkeyComponent = PackkeyComponent;
//# sourceMappingURL=Packkey.component.js.map